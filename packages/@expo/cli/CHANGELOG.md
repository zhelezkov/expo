...
- Fix long project paths overflowing the dev server interstitial page by making the path scroll horizontally. ([#XXXX](https://github.com/expo/expo/pull/XXXX) by [@EvanBacon](https://github.com/EvanBacon))
